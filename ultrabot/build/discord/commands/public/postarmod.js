...
createCommand({
    ...
    async run(interaction) {
        ...
        if (titulo)
            embed.setTitle(processarTexto(titulo));
        if (descricaoCompleta)
            embed.setDescription(descricaoCompleta);
        if (imagem)
